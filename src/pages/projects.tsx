...
export default function Projects() {
  ...
  return (
    <>
      <Head>
        <title>Projects | Turin Jana </title>
        <meta
          name="description"
          content="I love to code using tools like Html, Css and Javascript and Styled Components and more! Here are some of my favorite projects."
        />
        <meta property="og:title" content="Projects | Turinjana" />
        <meta
      ...
      <T.Section>
        ...
        <p className="github">
              ...
              <a href="https://github.com/TtRr19" style={{textDecoration: 'underline',}}> my GitHub </a>
              !!
        </p>
      </T.Section>
